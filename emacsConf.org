  ...
  (use-package org
    ...
    (setq org-todo-keyword-faces
      '(("TODO" . (:foreground "white" :background "red" :weight bold))
        ("PROG" . (:foreground "black" :background "yellow" :weight bold))
...
#+begin_src emacs-lisp
  ...
  (use-package org-modern
    ...
    :config
    (set-face-attribute 'org-modern-label nil :height 1.0 :width 'regular)
    (set-face-attribute 'org-modern-todo nil :inverse-video nil)
    (set-face-attribute 'org-modern-done nil :inverse-video nil))
