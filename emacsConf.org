...
(setq modus-vivendi-tinted-palette-overrides
      ...
      (bg-green-intense   "#0f9938")
      (bg-blue-intense    "#0f3d99")
      (bg-yellow-intense  "#99760f")
      (bg-magenta-intense "#991e78")
      (bg-cyan-intense    "#0f8499")
      (bg-purple-intense  "#4a0f99")
      (bg-orange-intense  "#99410f")

      (bg-red-subtle      "#660a1e")
      (bg-green-subtle    "#0a6625")
      (bg-blue-subtle     "#0a2866")
      (bg-yellow-subtle   "#664f0a")
      (bg-magenta-subtle  "#661450")
      (bg-cyan-subtle     "#0a5866")
      (bg-purple-subtle   "#310a66")
      (bg-orange-subtle   "#662b0a")
